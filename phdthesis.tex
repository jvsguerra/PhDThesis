...
Tracking the job submission provides valuable information about system usage patterns and helps identify periods of high demand. This insight enables the optimization of resources to ensure a smooth and efficient user experience. Additionally, it helps us identify user adherence to our platform and the impact of new features and updates. From March 2023 to November 2023, KVFinder-web executed 1,039 jobs, with an average of $\sim115$ jobs per month (Figure \ref{fig:job-execution}). From March 2023 to May 2023, KVFinder-web was under development and only accessible for internal users from CNPEM, reaching an average of $\sim65$. In June 2023, KVFinder-web was released to the public, alongside its publication in \textit{Nucleic Acids Research} \cite{guerra2023A}. After publication, KVFinder-web had an average of $\sim141$ jobs per month, showing the user adherance to our web application and the impact of its publication.
