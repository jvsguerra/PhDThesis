...
I would like to express my sincere gratitude to all who supported me during the development of this project. Firstly, I am thankful to my parents, Roseli do Carmo Freitas da Silva and Mario Luiz da Silva Guerra, for their support throughout every stage of my academic and professional journey. I appreciate my partner, Bruna Martins da Silva, for her unwavering support in all phases of this project.

I want to thank my advisor, Dr. Paulo Sergio Lopes de Oliveira, for providing me with scientific and creative freedom to develop this thesis and, above all, for the opportunity to work in a research center of excellence with essential support from his part. I extend my gratitude to my colleagues and former colleagues at the Computational Biology Laboratory, Dr. José Geraldo de Carvalho Pereira, Dr. Helder Veras Ribeiro Filho, MSc. Luiz Fernando Giolo Alves, Dr. Mariana Bortoletto Grizante, Dr. Gabriel Ernesto Jara, and Dr. Leandro Oliveira Bortot, for supporting me in crucial moments, sharing ideas, and providing suggestions for the development of this project. Specifically, I would like to thank Dr. Helder Veras Ribeiro Filho and Dr. José Geraldo de Carvalho Pereira for their support in the development and planning of tools, as well as Dr. Gabriel Ernesto Jara and Dr. Leandro Oliveira Bortot for their assistance in molecular dynamics-related topics. I am immensely grateful to all who aided me in this essential stage of my academic journey.

Lastly, I appreciate the Postgraduate Program in Pharmaceutical Sciences (PPGCF) at the Faculty of Pharmaceutical Sciences (FCF) of the University of Campinas (UNICAMP), the National Laboratory of Biosciences (LNBio), and the National Center for Research in Energy and Materials (CNPEM) for enabling this work. I am also thankful for the financial support from the São Paulo Research Foundation (FAPESP) for the regular research project (grant number 2018/00629-0).
...
The identification of binding sites through purely geometric approaches is efficient in identifying all the cavities of a given target protein. However, the challenge lies in recognizing which of these cavities are functionally relevant as binding sites \cite{sotriffer2002,henrich2010,guerra2019}. While there is no simple and effective approach, the characterization of binding sites in terms of their properties can lead to the identification of functionally relevant binding sites. Since the various interactions occurring in a cavity are inherently linked to its properties, these interactions determine the biological function of the biomolecule \cite{sotriffer2002,henrich2010}. Therefore, the geometric, topological, and physicochemical properties in a biomolecular cavity can be employed to identify potential binding sites relevant to the studied interactions.

% Interactions within a biomolecular cavity dictate its properties, influencing the biological function of the biomolecule (Sotriffer; Klebe, 2002). Spatial and physicochemical properties within biomolecular cavities aid in identifying potential binding sites relevant to studied interactions.

% Interactions per Ligand (IPL) and Interactions per Protein (IPP) at binding sites arise from properties of protein cavities dictating molecular recognition of ligands, from small molecules to supramolecules (Sotriffer; Klebe, 2002). Molecular recognition depends on spatial and physicochemical complementarity between the target protein and its ligand (Henrich et al., 2010; Daberdaku; Ferrari, 2016). Binding sites impose spatial and physicochemical constraints on putative ligands (Sotriffer; Klebe, 2002), with each interaction triggering a distinct biological function. Describing potential binding sites in these terms is crucial for rational drug design and optimization, and assessing binding site druggability (Hubbard; Argos, 1994; Liang; Woodward; Edelsbrunner, 1998; Daberdaku; Ferrari, 2016).

% Inference of protein cavity functionality is achieved through comparison with homologous proteins, determined by homology and sequential similarity of active sites (Juncker et al., 2009). Protein 3D structure (spatial folding) aids in comparing protein folding using databases like PDB (Berman, 2000) and CATH (Sillitoe et al., 2014). Local structural patterns, like catalytic triads of serine proteases, play a role in determining function (Dodson; Wlodawer, 1998). Describing a protein cavity by the location of different residue types aids in understanding its functionality (Figure 3).

% Binding sites have conserved amino acid sequences within protein families, providing functional information (Henrich et al., 2010). Amino acid composition characterizes enzymatic and non-enzymatic binding sites, showing different compositions between them (Bartlett et al., 2002; Soga et al., 2007; Carlson et al., 2008). The affinity of binding sites is governed by amino acid composition, allowing for accurate drug design (Carlson et al., 2008).

% Interactions' energetically favorable environment relies on van der Waals, hydrophobic, electrostatic, hydrogen bonding, and solvation interactions (Morris et al., 2009; Henrich et al., 2010). Important physicochemical properties of binding sites include the electrostatic potential and hydrophobicity.

% The electrostatic potential is calculated by the Poisson-Boltzmann equation (PBE) (Honig; Nicholls, 1995), estimating ligand anchoring points, interaction free energy, biomolecule stability, and average atomic forces.

% Hydrophobicity, described by the partition coefficient P (logP), plays a role in drug action's kinetic and dynamic characteristics (Mannhold et al., 2009). It is governed by the shape of the binding site and the exposed area of residues (Henrich et al., 2010). Different approaches generate various hydrophobicity scales for amino acids (Heiden; Moeckel; Brickmann, 1993).

% Current methods predict partition coefficients based on substructure or property approaches, such as HINT (Kellogg; Semus; Abraham, 1991), ALOGPS (Tetko; Tanchuk, 2002), KLOGP (Zhu et al., 2005), and MLP (Oberhauser; Nurisso; Carrupt, 2014). These approaches estimate logP through substructure breakdown or molecular and topological descriptors, aiding in drug design (Mannhold et al., 2009).

\section{State of the Art \label{sec:state-of-the-art}}

\subsection{Geometric Approaches \label{sec:geometric-approaches}}

\subsection{Principal Available Computational Tools \label{sec:computational-tools}}
