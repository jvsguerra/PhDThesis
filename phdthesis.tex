...
\begin{figure}[ht]
  \centerline{\includegraphics[scale=0.8]{images/smc-re-plots.png}}
...
% \begin{table}[!ht]
%   \centering
%   \caption[Performance of the well-established cavity detection tools in Benchmark dataset 2]{\textbf{Performance of the well-established cavity detection tools in benchmark dataset 2.} Estimated cavity volumes by the well-established cavity detection tools. The relative error are calculated using the "real" cavity volume as reference and can be found in paratheses. $V$: average cavity volume. $V_{guest}$: guest \acs{vdW} volume. $V = V_{guest} / 0.55$.}
%   \scalebox{0.7}{
...
%       A1 & 1315 & 1399 (6.4\%) & 1387 (5.5\%) & 1411 (7.3\%) & 1778 (35.2\%) & 1362 (3.6\%) \\
%       C1 & 549 & 558 (1.6\%) & 617 (12.3\%) & 648 (17.9\%) & 569 (3.6\%) & 669 (21.7\%) \\ 
%       F1 & 500 & 463 (-7.5\%) & 483 (-3.5\%) & 653 (30.6\%) & 481 (-3.9\%) & 655 (30.9\%) \\ 
%       F2 & 42572 & 37728 (-11.4\%) & 39077 (-8.2\%) & 62843 (47.6\%) & 22941 (-46.1\%) & 59147 (38.9\%) \\ 
%       H1 & 259 & 226 (-12.8\%) & 211 (-18.6\%) & 409 (58.1\%) & 215 (-16.8\%) & 429 (65.5\%) \\ 
%       N1 & 434 & 488 (12.4\%) & 495 (14\%) & 526 (21.2\%) & 543 (25.1\%) & 461 (6.2\%) & 211 (-51.4\%) \\ 
%       O1 & 142 & 160 (12.9\%) & 177 (24.5\%) & 172 (21.2\%) & 199 (40\%) & 146 (3.2\%) \\ 
%       O2 & 20 & 36 (78.8\%) & 0 (-100\%) & 37 (82.2\%) & 0 (-100\%) & 0 (-100\%) \\ 
%       W1 & 696 & 866 (24.4\%) & 542 (-22.2\%) & 984 (41.3\%) & 1008 (44.8\%) & 936 (34.4\%) \\ \hline
%       \textbf{MRAE} & ~ & \textbf{18.7\%} & \textbf{23.2\%} & \textbf{36.4\%} & \textbf{35.1\%} & \textbf{33.8\%} \\ \hline
%     \end{tabular}
%   }
%   \label{tab:benchmark-1}
% \end{table}
