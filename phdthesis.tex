...
% The \ac{parKVFinder} \cite{guerra2020} is an open-source tool, licensed under GPL v3.0, developed for the detection and characterization of any type of biomolecular cavity. The tool was originally developed in the master's thesis entitled "Prospecção e caracterização de cavidades supramoleculares" \cite{guerra2019}, as an updated, optimized and parallelized version of KVFinder \cite{oliveira2014}. Subsequently, parKVFinder was published in SoftwareX \cite{guerra2020}, improving the estimation of surface area, and was released as \href{https://github.com/LBC-LNBio/parKVFinder/tree/v1.0}{parKVFinder v1.0}. Following this, there was a new update to KVFinder-web \cite{guerra2023A}, adding depth, hydrophobicity, and residue frequency descriptors, resulting in the release of \href{https://github.com/LBC-LNBio/parKVFinder/tree/v1.2.0}{parKVFinder v1.2.0}
