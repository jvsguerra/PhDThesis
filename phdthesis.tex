...
Biomolecules and their binding sites can be represented in a 3D grid, subdivided into volumetric pixels, commonly known as voxels. This grid stores values in a matrix where each element is denoted as a voxel. A voxel, in this context, represents a discrete point of data within a 3D grid, and each point can contain multiple types of information, allowing the representation of different properties within a specific portion of space in a straightforward and efficient manner (Figure \ref{fig:voxel}). In computer science, the 3D grid is a data structure commonly used in image processing and computer vision applications, inclusing tasks such as image reconstruction, image segmentation, and object detection.
