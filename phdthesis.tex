...
\hypersetup{
  ...
  pdfkeywords  = {structural biology, data science, computational platform, binding sites, molecular dynamics, data coding, cavity detection, solvent accessibility},
...
\avaliadorA{Prof. Dr. Paulo Sergio Lopes de Oliveira}{Centro Nacional de Pesquisa em Energia e Materiais (CNPEM)}
...
\fichacatalografica{images/ficha-catalografica.pdf}
...
\begin{acronym} \itemsep=-8pt
  ...
  \acro{CAPES}[CAPES]{\textit{Coordenação de Aperfeiçoamento de Pessoal de Nível Superior - Brasil}}
...
Binding sites are found within a diverse array of cavities, yet a formal mathematical definition of biomolecular cavities remains elusive \cite{simoes2017,guerra2019}. Using the mathematical theory of convexity \cite{lay2013,simoes2017}, a cavity is defined as a connected component within the complement space of the biomolecule enclosed by its convex hull. As a topological entity, the connected components (\ie, cavities) are related to the first Betti number $\beta_0$ (\ie, the number of connected components) of the complement space. In \acs{3D}, biomolecules are represented as shapes, with connected components corresponding to Betti numbers $\beta_i$ ($i=0,1,2$) in \acs{3D}. Consequently, cavities are categorized based on their morphology as voids (0-ary), pockets (1-ary), and channels (2-ary) (Figure \ref{fig:cavity-classification}). Pockets can be further categorized into clefts, grooves, invaginations and tunnels.

In biomolecules, particularly proteins and nucleic acids, solvent-exposed clefts or buried cavities are crucial for ligand binding, which can ultimately regulate biological function \cite{liang1998,sotriffer2002,henrich2010}. The identification and characterization of these binding sites are fundamental for comprehending the intricate biomolecular interactions and their diverse functions. Morphological, topological and physicochemical properties at the contact interface, \eg, shape, volume, area, charge, hydrophobicity, solvation, and type of interactions, dictate the functions and interactions of biomolecules \cite{hubbard1994,bohacek1997,sotriffer2002,henrich2010,guerra2019}. Identifying and sizing these cavities are initial steps in designing ligands based on protein structures \cite{liang1998}. Moreover, the structural and physicochemical characteristics of proteins are valuable in drug discovery and design \cite{guerra2019}.

\begin{figure}[ht]
  \centerline{\includegraphics[scale=0.95]{images/cavity-classification.png}}
...
\begin{figure}[H]
  \centerline{\includegraphics[scale=0.9]{images/kvfinder-suite-schema.png}}
...
\begin{figure}[h]
  \centering
  \includegraphics[scale=1.05]{images/pykvfinder-speedup.png}
...
\begin{figure}[h]
  \centering
  \includegraphics[scale=0.9]{images/pykvfinder-parkvfinder-kv1000-comparison.png}
...
\begin{figure}[ht]
  \centering
  \includegraphics[scale=1.55]{images/kvweb-overview.png}
...
\begin{figure}[h]
  \centering
  \includegraphics[scale=1.55]{images/web-queue-worker-architecture.png}
...
\begin{figure}[h]
  \centering
  \includegraphics[scale=1.4]{images/kvweb-performance.png}
  \centerline{\scriptsize{\textbf{Source:} Reprinted from \cite{guerra2023A}. Licensed under \href{https://creativecommons.org/licenses/by/4.0/}{CC BY 4.0}.}}
...
\begin{figure}[h]
  \centering
  \includegraphics[scale=0.4]{images/serd-spyke.png}
...
\begin{figure}[h]
  \centering
  \includegraphics[scale=0.6]{images/graph-representation-of-binding-sites.png}
...
\begin{figure}[h]
  \centering
  \includegraphics[scale=0.27]{images/molecular-recognition.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[scale=0.815]{images/kvmd-overview.png}
...
\begin{figure}[h]
  \centering
  \includegraphics[scale=1.05]{images/HIV-1-clustering-results.png}
