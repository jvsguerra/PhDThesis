...
% Besides being able to accurately detect biomolecular cavities, current software must
% also perform fast detection and characterizations. Thus, we also evaluated the elapsed
% time to execute these benchmarking methods (Fig. 4c). pyKVFinder outperformed all
% analyzed methods. Even when applying the newly available characterization, depth
% and hydropathy, pyKVFinder’s elapsed time only increased 36\%, still outperforming
