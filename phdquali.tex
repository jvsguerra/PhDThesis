...
Embora tenhamos obtido sucesso na aplicação do parKVFinder em simulações de dinâmica molecular \cite{guerra2020} e em um estudo comparativo \cite{ribeiro2021}, a ferramenta apresentou limitações quando se trata de aplicações automatizadas e comparações sistemáticas de cavidades. Nesse sentido, é desejável ter um pacote mais voltado para ciência de dados, especialmente com acesso a funções e estruturas de dados durante a execução. No entanto, o parKVFinder ainda tem seu escopo, especialmente para otimização dos parâmetros de detecção e caracterização, por meio do plugin gráfico do PyMOL, devido aos seus recursos visuais, que posteriormente podem ser adotados em estudos automatizados. Além disso, o parKVFinder é útil para análises focadas em uma única estrutura.
