...
\begin{figure}[h]
  \centering
  \includegraphics[scale=1.5]{images/pymol-kvweb-tools.png}
  \centerline{\scriptsize{\textbf{Fonte:} Adaptado de \cite{guerra2023A}.}}
...
\begin{figure}[h]
  \centering
  \includegraphics[scale=1.5]{images/kvweb-case-study.png}
  \centerline{\scriptsize{\textbf{Fonte:} Adaptado de \cite{guerra2023A}.}}
